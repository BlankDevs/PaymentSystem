...
$logFile = fopen('notify.txt', 'wb') or die(); // log results to file due to lack of DB

$check1 = pfValidSignature($pfData, $pfParamString);
$check2 = pfValidIP();
$check3 = pfValidPaymentData('100.00', $pfData); // hard-code for demo purposes, use DB lookup in production
